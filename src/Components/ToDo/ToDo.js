...
export const ToDo = () => {
    ...
    const [allInput, setAllInput] = useState([{notiz: "Eine Test to do", id: 464646545646, date:"2022-11-01", prio:1}])
                ...
                <div className="containerfortheinputsection" > 
                    <form className="formfortheinputsection" onSubmit={handleSubmit}>
                        <div className="containerforinputtext"> 
                            <input className="inputfieldtext" onChange={getInputValue} type="text" value={inputValue} id="gh"  name="te" required ></input>
                        </div>
