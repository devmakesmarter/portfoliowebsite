...
export const Product = ({ img, description, price, handlePrice, id }) => {
    ...
    return ( <
        ...
        Row >
        <
        Col > < img className = "img-fluid w-100"
        src = { img }
        /></Col >
        <
        /Row> <
        ...
        Row >
        <
        Col className = "col-12" > < Button onClick = { handlePrice }
        id = { id }
        className = "btn btn-dark btn-lg btn-block w-100 text-light" > { price + " €" } < /Button></Col >
        <
        /Row> <
        /Container>
